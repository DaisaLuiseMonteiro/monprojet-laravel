# Étape 1 : Build des dépendances PHP et Composer
...
# Copier les dépendances depuis le build précédent
...
# Générer la clé d'application et optimiser (sera exécuté si artisan existe)
